      ...
      await resend.emails.send({
        ...
        html: `
          <div style="font-family:sans-serif;max-width:600px;margin:0 auto;color:#1A1A1A;">
            <h2 style="color:#2563EB;margin-bottom:4px;">New testimonial received!</h2>
            ...
            <blockquote style="border-left:3px solid #2563EB;margin:0;padding:12px 16px;background:#FAF8F5;border-radius:0 8px 8px 0;font-style:italic;color:#6B6B6B;">
              ${input.body}
            </blockquote>
            <a href="${siteUrl}/dashboard" style="display:inline-block;margin-top:24px;background:#2563EB;color:white;padding:10px 22px;border-radius:8px;text-decoration:none;font-weight:600;font-size:14px;">
              View in dashboard →
            </a>
          </div>
        `,

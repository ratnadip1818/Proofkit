...
export default function WidgetClientWrapper({
  ...
  const [config, setConfig] = useState<WidgetConfig>(() => {
    ...
    const requestedType: WidgetType =
      spType === "carousel" || spType === "marquee" || spType === "single" || spType === "spotlight" || spType === "conversation" || spType === "bento" || spType === "orbit" || spType === "ribbon" || spType === "stack"
        ? spType
        : "wall";
  ...
  useEffect(() => {
    ...
    if (spType) {
      const requestedType: WidgetType =
        spType === "carousel" || spType === "marquee" || spType === "single" || spType === "spotlight" || spType === "conversation" || spType === "bento" || spType === "orbit" || spType === "living_feed" || spType === "ribbon" || spType === "stack"
          ? spType
          : "wall";

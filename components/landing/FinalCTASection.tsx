...
export default function FinalCTASection() {
  return (
    <section className="w-full bg-[#FAF8F5] border-t border-[#1A1A1A]/5 px-5 py-36 md:px-10 md:py-48 select-none relative overflow-hidden">
      ...
      <div className="absolute top-1/2 left-1/2 h-[600px] w-[600px] -translate-x-1/2 -translate-y-1/2 rounded-full bg-[radial-gradient(circle,rgba(11,84,216,0.02)_0%,transparent_70%)] pointer-events-none" />
      ...
      <div className="mx-auto w-full max-w-[720px] text-center relative z-10">
        <Reveal>
          ...
          >
            ...
            <span
              className="font-normal italic text-[#0b54d8] block sm:inline"
        ...
        <Reveal delay={0.14}>
          <div className="mt-10 flex flex-col items-center gap-4 sm:flex-row sm:justify-center">
            <Link
              href="/signup"
              className="group flex items-center gap-2 rounded-full bg-[#0b54d8] px-8 py-4 text-sm font-bold text-white shadow-xs transition-product duration-button ease-product hover:bg-[#0945b3] hover:translate-y-[-1px] hover:shadow-md"
            >
              Start Free

...
export default function PricingSection() {
  return (
    <section
      id="pricing"
      className="relative w-full overflow-hidden bg-[#FAF8F5] border-t border-[#ECE7E0] px-5 py-28 md:px-10 md:py-36"
    >
      ...
      <div
        ...
        style={{
          background:
            "radial-gradient(ellipse 50% 45% at 75% 50%, rgba(232,116,59,0.02) 0%, transparent 70%)",
        }}
        aria-hidden="true"
      />
      ...
      <div className="relative mx-auto grid w-full max-w-[1100px] items-start gap-12 lg:grid-cols-[1fr_460px] lg:gap-20">
        ...
        <div className="lg:sticky lg:top-32">
          <Reveal>
            ...
            <h2
              className="text-[clamp(2rem,5vw,3.75rem)] font-extrabold leading-[1.05] tracking-tight text-[#1A1A1A]"
            ...
            <p className="mt-5 max-w-md text-base leading-relaxed text-[#6B6B6B] md:text-lg">
            ...
            <div className="mt-8 flex flex-col gap-3 text-sm text-[#6B6B6B]">
              <span className="flex items-center gap-2">
                <Check size={16} className="text-[#2E9E6B]" strokeWidth={2.5} />
        ...
        <Reveal delay={0.1} y={56}>
          <div className="group relative overflow-hidden rounded-3xl border border-[#ECE7E0] bg-white p-8 shadow-[0_4px_20px_rgba(0,0,0,0.02),_0_1px_3px_rgba(0,0,0,0.02)] transition-all duration-300 hover:-translate-y-1 hover:border-[#E8743B]/40 hover:shadow-[0_24px_56px_rgba(232,116,59,0.08)] md:p-10">
            ...
            <Link
              href="/signup"
              className="mt-8 flex w-full items-center justify-center rounded-full bg-[#E8743B] py-4 text-base font-semibold text-white shadow-[0_12px_24px_rgba(232,116,59,0.15)] transition-all hover:scale-[1.02] hover:bg-[#CF5F2C] active:scale-95"
            >
              Get Blovi — $49
            </Link>
